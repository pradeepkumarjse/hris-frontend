...
export default function Nav({ openNav, onCloseNav }) {
  ...
  // const updateData = () => {
  //   dispatch(setData({ currentUser: 'new data' }));
  // };
...
function NavItem({ item }) {
  ...
  const handleLogout = () => {
    // Dispatching actions to log out the user
  ...
  return (
    <ListItemButton
      ...
      href={item.path}
      onClick={item.title === 'Logout' ? handleLogout : undefined} // Conditionally call handleLogout
      sx={{
        minHeight: 44,
        borderRadius: 0.75,
        typography: 'body2',
